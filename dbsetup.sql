...
create table games(id int primary key auto_increment, player1 int, player2 int, player1score tinyint unsigned, player2score tinyint unsigned, `date` date, validated bool);